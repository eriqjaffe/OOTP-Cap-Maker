...
(function(R) {
	...
	*/
	...
	//R.fn.toSVG = function(ifG,ifD,ofG) {
	R.fn.toSVG = function() {
		var
			paper   = this,
			restore = { svg: R.svg, vml: R.vml },
			//svg     = '<svg id="theSVG" style="overflow: hidden; position: relative;" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="' + paper.width + '" version="1.1" height="' + paper.height + '">'
			svg     = '<svg id="theSVG" style="overflow: hidden; position: relative;" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="100%" version="1.1" height="100%" viewBox="0 0 600 600" preserveAspectRatio="xMinYMin slice">'
					+ '<defs>'
					+ '<pattern id="dirt" patternUnits="userSpaceOnUse" width="100" height="100"><image xlink:href="images/SoilSand0218_9_S.jpg" x="0" y="0" width="100" height="100" /></pattern>'
					+ '<pattern id="grass" patternUnits="userSpaceOnUse" width="100" height="100"><image xlink:href="images/grass2.png" x="0" y="0" width="100" height="100" /></pattern>'
					+ '<pattern id="lawn" patternUnits="userSpaceOnUse" width="100" height="100"><image xlink:href="images/Grass0053_26_S.jpg" x="0" y="0" width="100" height="100" /></pattern>'
					+ '<pattern id="field" patternUnits="userSpaceOnUse" width="100" height="100"><image xlink:href="images/Grass0053_24_S.jpg" x="0" y="0" width="100" height="100" /></pattern>'
					+'<pattern id="astroturf" patternUnits="userSpaceOnUse" width="100" height="100"><image xlink:href="images/ATurf0020_2_S.jpg" x="0" y="0" width="100" height="100" /></pattern>'
					+'<pattern id="fieldturf" patternUnits="userSpaceOnUse" width="100" height="100"><image xlink:href="images/FTurf0020_2_S.jpg" x="0" y="0" width="100" height="100" /></pattern>'
					+'<clipPath id="clipping" transform="matrix(-0.7071,-0.7071,0.7071,-0.7071,300,482)"><path fill="#FFFFFF" stroke="#000000" stroke-width="1.5794" stroke-miterlimit="10" d="clippingpathhere"/></clipPath>'
					+'</defs>';
			;
